...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'open_cell_volume',
        'closed_cell_volume',
        'total_volume_previous_year',
        'preferred_foam_brand',
        'preferred_rig_type',
        'power_source',
        'proportioner_brand',
        'proportioner_model',
        ...
        'zip_postal_code',
        'address_line1',
        'appartment_building_suite_other',
        'city_town',
        'state_region',
        'quiz_approved',
        'beneficial_owner_check',
        'legal_representative_check',
        'primary_contact_person_check',
    ];
   ...
   // new seller sign-up flow relations
    public function SellerRegisteredBusiness(){
        return $this->hasOne(UsersRegisteredBusiness::class, 'user_id', 'id');
    }

    public function SellerPaymentsInfo(){
        return $this->hasOne(UserPaymentsInfo::class, 'user_id', 'id');
    }
    
    public function SellerPhoneNumbers(){
        return $this->hasMany(UsersPhoneNumbers::class, 'user_id', 'id');
    }
