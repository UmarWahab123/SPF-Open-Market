...
class Order extends Model
{
    ...
    //         SellerProductSKU::class,
    //         'order_product_details',
    //         'package_id',       // Refers to `OrderPackageDetail` ID
    //         'product_sku_id'    // Refers to `SellerProductSKU` ID
    //     )->withPivot('qty', 'price', 'total_price', 'tax_amount')
    //      ->withTimestamps();
    // }
