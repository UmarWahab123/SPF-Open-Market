...
Route::middleware(['auth','admin'])->prefix('admin')->group(function() {
    ...
    Route::get('/merchant/{id}/delete', 'MerchantController@delete')->name('admin.merchant_delete')->middleware(['permission']);
    ...
    Route::post('/seller-is-active-status-update','MerchantController@is_active_status_update')->name('admin.seller.is_active.status.update')->middleware(['prohibited_demo_mode']);
...
Route::middleware(['auth','seller'])->prefix('seller')->as('seller.')->group(function() {
    ...
    Route::post('/profile/seller-business/update','ProfileController@updateSellerForm')->name('seller-business.info.update')->middleware('prohibited_demo_mode');
    
    //new seller profile routes 
     Route::post('/profile/seller-profile/update/{id}','ProfileController@updateSellerProfileInfo')->name('profile.seller-profile.update')->middleware('prohibited_demo_mode');
