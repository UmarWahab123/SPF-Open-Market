                ...
                <div class="col-lg-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex w-100 justify-content-between">
                            ...
                            <a id="create_new_seller_btn" class="primary-btn radius_30px mr-10 fix-gr-bg d-none" href="{{route('seller.subscription_payment_select',encrypt($subscription->id))}}"><i class="ti-plus"></i>{{ __('seller.advance_renew_subscription') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
