    ...
    <script type="text/javascript">
        ...
        (function($){
            ...
            $(document).ready(function(){
               ...
               $(document).on('change', '.seller-is-active-status-update', function(event){
                    let id = $(this).data('id');
                    ...
                    $.post('{{ route('admin.seller.is_active.status.update') }}', {_token:'{{ csrf_token() }}', id:id, is_active:is_active, seller_id:seller_id}, function(data){
                        if(data == 1){
                            toastr.success("{{__('common.updated_successfully')}}","{{__('common.success')}}");
                        }else{
                            toastr.error("{{__('common.error_message')}}","{{__('common.error')}}");
