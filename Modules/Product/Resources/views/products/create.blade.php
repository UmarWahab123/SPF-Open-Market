                            ...
                            <div class="white_box pt-0 box_shadow_white mb-20 p-15">
                                       ...
                                       <div class="row">
                                           <div class="col-lg-3">
                                               <div class="primary_input mb-15">
                                                   ...
                                                   <input class="primary_input_field" name="weight" id="weight" type="number" min="0" step="{{step_decimal()}}" value="{{old('weight')}}" required>
                                           ...
                                           <div class="col-lg-3">
                                               <div class="primary_input mb-15">
                                                   <label class="primary_input_label" for="length"> {{ __('product.length')}} [{{__('product.cm')}}] <span
                                                                class="text-danger">*</span></label>
                                                   <input class="primary_input_field" name="length" id="length" type="number" min="0" step="{{step_decimal()}}" value="{{old('length')}}" required>
                                                   <span class="text-danger" id="error_length">{{ $errors->first('length') }}</span>
                                               </div>
                                           </div>
                                           <div class="col-lg-3">
                                               <div class="primary_input mb-15">
                                                   <label class="primary_input_label" for="breadth"> {{ __('product.breadth')}} [{{__('product.cm')}}] <span
                                                                class="text-danger">*</span></label>
                                                   <input class="primary_input_field" name="breadth" id="breadth" type="number" min="0" step="{{step_decimal()}}" value="{{old('breadth')}}" required>
                                           ...
                                           <div class="col-lg-3">
                                               <div class="primary_input mb-15">
                                                   <label class="primary_input_label" for="height"> {{ __('product.height')}} [{{__('product.cm')}}] <span
                                                                class="text-danger">*</span></label>
                                                   <input class="primary_input_field" name="height" id="height" type="number" min="0" step="{{step_decimal()}}" value="{{old('height')}}" required>
                               ...
                               <div class="col-lg-3">
                                        ...
                                        <div class="tab-content">
                                            @foreach ($LanguageList as $key => $language)
                                                <div role="tabpanel" class="tab-pane fade pelement @if (auth()->user()->lang_code == $language->code) show active @endif" id="pelement{{$language->code}}">
                                                    <div class="col-lg-12">
                                                        <div class="main-title d-flex">
                                                            <h3 class="mb-3 mr-30">{{ __('common.description') }}adsf</h3>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                   ...
                                                   {{-- new product field --}}
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            <textarea class="summernote3" id="benefits" name="benefits[{{$language->code}}]"> {{old('benefits.'.$language->code)}}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="main-title d-flex">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            <textarea class="summernote4" id="terms" name="terms[{{$language->code}}]"> {{old('terms.'.$language->code)}}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="main-title d-flex">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            <textarea class="summernote5" id="cancelation" name="cancelation[{{$language->code}}]"> {{old('cancelation.'.$language->code)}}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="main-title d-flex">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            <textarea class="summernote6" id="discounts" name="discounts[{{$language->code}}]"> {{old('discounts.'.$language->code)}}</textarea>
                                                        </div>
                                                    </div>
                                ...
                                @else
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            <textarea class="summernote3" id="benefits" name="benefits"> {{old('benefits')}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="main-title d-flex">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            <textarea class="summernote4" id="terms" name="terms"> {{old('terms')}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="main-title d-flex">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            <textarea class="summernote5" id="cancelation" name="cancelation"> {{old('cancelation')}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="main-title d-flex">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            <textarea class="summernote6" id="discounts" name="discounts"> {{old('discounts')}}</textarea>
                                        </div>
                                    </div>
