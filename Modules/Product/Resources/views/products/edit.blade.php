                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 weight_height_div">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for="weight"> {{__('product.weight')}} [{{__('product.gm')}}] <span
                                                                class="text-danger">*</span></label>
                                                        <input value="{{@$product->skus->first()->weight}}" class="primary_input_field" name="weight" id="weight" type="number" min="0" step="{{step_decimal()}}" required>
                                                        <span class="text-danger" id="error_weight">{{ $errors->first('weight') }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for="length"> {{ __('product.length')}} [{{__('product.cm')}}] <span
                                                                class="text-danger">*</span></label>
                                                        <input value="{{@getNumberTranslate($product->skus->first()->length)}}" class="primary_input_field" name="length" id="length" type="number" min="0" step="{{step_decimal()}}" required>
                                                        <span class="text-danger" id="error_length">{{ $errors->first('length') }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for=""> {{ __('product.breadth')}} [{{__('product.cm')}}] <span
                                                                class="text-danger">*</span></label>
                                                        <input value="{{@$product->skus->first()->breadth}}" class="primary_input_field" name="breadth" id="breadth" type="number" min="0" step="{{step_decimal()}}" required>
                                                        <span class="text-danger" id="error_breadth">{{ $errors->first('breadth') }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for=""> {{ __('product.height')}} [{{__('product.cm')}}] <span
                                                                class="text-danger">*</span></label>
                                                        <input value="{{@$product->skus->first()->height}}" class="primary_input_field" name="height" id="height"
                                                               type="number" min="0" step="{{step_decimal()}}" required>
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade pelement @if (auth()->user()->lang_code == $language->code) show active @endif" id="pelement{{$language->code}}">
                                                        ...
                                                        <div class="col-lg-12">
                                                          ...
                                                          {{-- new product field --}}
                                                            <div class="col-lg-12">
                                                                <div class="main-title d-flex">
                                                                    <h3 class="mb-3 mr-30">{{ __('Benefits') }}</h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="primary_input mb-15">
                                                                    <textarea class="summernote3" id="benefits" name="benefits[{{$language->code}}]">{{isset($product)?$product->getTranslation('benefits',$language->code):old('benefits.'.$language->code)}}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="main-title d-flex">
                                                                    <h3 class="mb-3 mr-30">{{ __('Terms') }}</h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="primary_input mb-15">
                                                                    <textarea class="summernote4" id="terms" name="terms[{{$language->code}}]">{{isset($product)?$product->getTranslation('terms',$language->code):old('terms.'.$language->code)}}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="main-title d-flex">
                                                                    <h3 class="mb-3 mr-30">{{ __('Cancelation') }}</h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="primary_input mb-15">
                                                                    <textarea class="summernote5" id="cancelation" name="cancelation[{{$language->code}}]">{{isset($product)?$product->getTranslation('cancelation',$language->code):old('cancelation.'.$language->code)}}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="main-title d-flex">
                                                                    <h3 class="mb-3 mr-30">{{ __('Discounts') }}</h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="primary_input mb-15">
                                                                    <textarea class="summernote6" id="discounts" name="discounts[{{$language->code}}]">{{isset($product)?$product->getTranslation('discounts',$language->code):old('discounts.'.$language->code)}}</textarea>
                                                                </div>
                                                            </div>
                                    ...
                                    @else
                                        ...
                                        <div class="col-lg-12">
                                          ...
                                          {{-- new product field --}}
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input mb-15">
                                                    <textarea class="summernote3" id="benefits" name="benefits">{{ $product->benefits }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="main-title d-flex">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input mb-15">
                                                    <textarea class="summernote4" id="terms" name="terms">{{ $product->terms }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="main-title d-flex">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input mb-15">
                                                    <textarea class="summernote5" id="cancelation" name="cancelation">{{ $product->cancelation }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="main-title d-flex">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input mb-15">
                                                    <textarea class="summernote6" id="discounts" name="discounts">{{ $product->discounts }}</textarea>
                                                </div>
                                            </div>
