            ...
            @endif
                ...
                <div class="col-lg-12">
                    <div class="primary_input mb-15">
                        ...
                        <textarea class="primary_textarea height_112 description" id="description" placeholder="{{__('common.description')}}" name="description" spellcheck="false">{{$category->description}}</textarea>
                        <span class="text-danger"></span>
                    </div>
                </div>
