                                    ...
                                    <div class="col-lg-8">
                                        <div class="white_box box_shadow_white mb-20 p-15">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12  weight_height_div">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="primary_input mb-15">
                                                                <label class="primary_input_label" for=""> {{ __('product.weight')}} [Gm]<span
                                                                class="text-danger">*</span></label>
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="primary_input mb-15">
                                                                <label class="primary_input_label" for=""> {{ __('product.length')}} [Cm]<span
                                                                class="text-danger">*</span></label>
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="primary_input mb-15">
                                                                <label class="primary_input_label" for=""> {{ __('product.breadth')}} [Cm] <span
                                                                class="text-danger">*</span></label>
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="primary_input mb-15">
                                                                <label class="primary_input_label" for=""> {{ __('product.height')}} [Cm] <span
                                                                class="text-danger">*</span></label>
                                            ...
                                            @else
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        <textarea class="summernote2" id="specification" name="specification"></textarea>
                                                    </div>
                                                </div>
                                                 {{-- new product field --}}
                                                    <div class="col-lg-12">
