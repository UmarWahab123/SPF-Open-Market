...
class WidgetController extends Controller
{
    ...
    public function getsectionForm(Request $request){
        try{
            ...
            $get_req = $request->except('_token');
            $homepagedata = HomePageSection::find($data['id']);
            return view('frontendcms::widget_manage.components.formdata_best_deals',compact('data','products','categories','brands','get_req' ,'homepagedata'));
