...
//new paypal payments routes
Route::get('paypal/payment', 'NewPayPalController@createPayment')->name('paypal.payment');
Route::post('paypal/success', 'NewPayPalController@success')->name('paypal.success');

Route::get('paypal/cancel', 'NewPayPalController@cancel')->name('paypal.cancel');
Route::post('paypal/execute', 'NewPayPalController@executePayment')->name('paypal.execute');
// Route::post('/paypal/webhook',  'PayPalWebhookController@handleWebhook');

// Route::post('paypal-payment', 'PayPalController@payment')->name('paypal.payment');  //temprary commented
