...
Route::prefix('customer')->group(function() {
    ...
    Route::post('/is-approved/update','CustomerController@update_approved_status')->name('customer.update_approved_status')->middleware(['auth','admin']);
     Route::post('/is-approved/quiz-approved','CustomerController@update_approved_quiz')->name('customer.update_approved_quiz')->middleware(['auth','admin']);
    ...
    Route::post('/Equipmentinfo/update','CustomerController@updateEquipmentInfo')->name('customer.equipmentupdate.info')->middleware(['auth','prohibited_demo_mode']);
    Route::post('/detailedinfo/update','CustomerController@updatedetailedInfo')->name('customer.detailed.info')->middleware(['auth','prohibited_demo_mode']);
