...
use App\Http\Controllers\Frontend\SubscriptionPlanController;
...
Route::view('/thank-you', 'frontend.amazy.auth.thankyou')->name('thankyou_page');
Route::view('/seller/thank-you', 'frontend.amazy.pages.seller_thank_you')->name('seller_thankyou_page');
Route::view('/certified_foam', 'frontend.amazy.pages.certified_foam')->name('certified_foam');
...
Route::get('cart/shipping-update', [ShipmentController::class, 'updateShipment'])->name('frontend.cart.shipping_update');
//Wishlist
...
//order
   ...
   //subscription plan
    Route::get('/subscription-plan',[SubscriptionPlanController::class,'subscription_plans_index'])->name('frontend.subscription_plans');
    Route::get('/customer-subscription-payment-select/{id}', [SubscriptionPlanController::class,'subscriptionPaymentPageDetails'])->name('frontend.subscription_payment_select');
    Route::get('/customer-subscription-payment-details/{id}', [SubscriptionPlanController::class,'subscriptionPaymentPage'])->name('frontend.subscription_payment_details');
    Route::get('subscription/payment/{id}',[SubscriptionPlanController::class,'subscriptionPaymentPage'])->name('frontend.subscriptionPaymentGateway');
    Route::post('/customer-subscription-payment', [SubscriptionPlanController::class,'subscriptionPayment'])->name('customer.subscription_payment');
    Route::get('/cancel-subscription-plan/{id}', [SubscriptionPlanController::class,'subscriptionCancel'])->name('customer.subscription_cancel');

    //paypal customer cancle and success route for the agreement approval 
...
Route::post('/hubspot/form/store', [ProductController::class, 'submitForm'])->name('form.submit'); 
Route::get('/newproduct/{seller}/{slug?}',[ProductController::class,'newShow'])->name('frontend');
...
Route::get('/shop',[ProductController::class,'index'])->name("frontend.shop");
Route::get('/all-products',[ProductController::class,'allProducts'])->name("frontend.all.products");
Route::get('/parts-finder-{slug?}', [ProductController::class, 'partFinder'])->name('frontend.part.finder');
Route::get('/compare-product-price/{price}', [ProductController::class, 'compareProductPrice'])->name('frontend.compare.product.price');
...
Route::get('/merchant-register-step-1',[MerchantRegisterController::class,'showRegisterFormStepFirst'])->name('frontend.merchant-register-step-first');
Route::get('/become-a-seller',[MerchantRegisterController::class,'newshowRegisterFormStepFirst'])->name('frontend.new-merchant-register-step-first');
 Route::get('/merchant-registers-step-1',[MerchantRegisterController::class,'newshowRegisterFormStepFirst'])->name('frontend.new-merchant-register-step-first');
Route::get('/seller-signup/{id}',[MerchantRegisterController::class,'showRegisterForm'])->name('frontend.merchant-register');
// Route::get('/merchant-register-step-2/{id}',[MerchantRegisterController::class,'showRegisterForm'])->name('frontend.merchant-register');
Route::get('/verify/otp/{id}',[MerchantRegisterController::class,'sendotpRegisterForm'])->name('frontend.otpmerchant-register');
Route::post('/verify/resend-otp/{id}', [MerchantRegisterController::class, 'resendOtp'])->name('frontend.resend-otpmerchant-register');
// Route::get('/merchant-register-step-2-otp/{id}',[MerchantRegisterController::class,'sendotpRegisterForm'])->name('frontend.otpmerchant-register');
Route::post('/seller-detail/{id}',[MerchantRegisterController::class,'verifyOtp'])->name('frontend.sellermerchant-register');
// Route::get('/seller-detail-save/{id}',[MerchantRegisterController::class,'users_registered_business'])->name('frontend.sellermerchantsave-register');
Route::post('/seller-detail-save/{id}', [MerchantRegisterController::class, 'users_registered_business'])->name('frontend.sellermerchantsave-register');


Route::post('/store-mobile-number', [MerchantRegisterController::class, 'storeMobileNumber'])->name('frontend.storeMobileNumber');
Route::get('/show_paymnet', [MerchantRegisterController::class, 'show_paymnet'])->name('frontend.show_paymnet'); 
// Route::post('/seller-Billing-address', [MerchantRegisterController::class, 'StoreBillingAddress'])->name('frontend.storeBilling-address')
Route::post('/store-Business-mobile-number', [MerchantRegisterController::class, 'registeredBusinessPhoneNumbers'])->name('frontend.registeredBusinessPhoneNumbers');
Route::post('/seller-card-save/{id}',[MerchantRegisterController::class,'seller_card_info'])->name('frontend.seller_card_info_save-register');
Route::post('/seller-stores-save/{id}',[MerchantRegisterController::class,'seller_stores_info_save'])->name('frontend.seller_stores_info_save');
Route::get('/seller-stores/{id}',[MerchantRegisterController::class,'show_seller_stores_info'])->name('frontend.seller_stores_info');
Route::get('/seller-detail-preview/{id}',[MerchantRegisterController::class,'showPreviousPage'])->name('frontend.previewsave-register');
Route::get('/seller-sellerinformation/{id}',[MerchantRegisterController::class,'preview_show_sellerinformation'])->name('frontend.preview_sellerinformation');
// Route::get('/merchant-register-step-2-seller/{id}',[MerchantRegisterController::class,'sellergetdataRegisterForm'])->name('frontend.sellermerchant-register');
Route::post('/merchant-register-step-2-verify/{id}',[MerchantRegisterController::class,'verifyOtp'])->name('otp.verify');
...
//staff
 ...
 Route::group(['middleware' => ['auth','customer'],'prefix' => 'profile'], function () {
     ...
     Route::get('/quiz', [ProfileController::class, 'buyerQuiz'])->name('frontend.buyer.quiz');
     Route::post('/buyer-quiz-store',[ProfileController::class,'buyerQuizStore'])->name('frontend.profile.quiz.store');
 });
