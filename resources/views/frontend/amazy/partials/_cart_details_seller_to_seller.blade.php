            ...
            <div class="checkout_v3_left d-flex justify-content-end mb-0">
                    ...
                    <div class="checkout_v3_inner w-100">
                                                ...
                                                <li class="list-group-item px-0 px-lg-3 mb_10">
                                                    <div class="row gutters-5 align-items-center">
                                                            ...
                                                            @if($cart->product->product->hasDeal)
                                                                @if($cart->product->product->hasDeal->discount > 0)
                                                                    @if($cart->product->product->hasDeal->discount_type == 0)
                                                                        <span class="green_badge text-nowrap d-none">-{{$cart->product->product->hasDeal->discount}}%</span>
                                                                    @else
                                                            ...
                                                            @else
                                                                @if(@$cart->product->product->hasDiscount == 'yes')
                                                                    @if($cart->product->product->discount_type == 0)
                                                                        <span class="green_badge text-nowrap d-none">-{{$cart->product->product->discount}}%</span><br>
                                                                    @else
                                                                        <span class="green_badge text-nowrap d-none">-{{single_price($cart->product->product->discount)}}</span>
                                                                    @endif
                                                                @endif
                                                            @endif
                                                            <h4 class="font_10 set_font_weight m-0 set_base_price{{$cart->id}}">{{single_price(isset($pro_price)?$pro_price:@$cart->product->sell_price)}}</h4>
                                                        ...
                                                        <div class="col-lg-2 text-center">
                                                           ...
                                                           @if(auth()->check() && $customerSubscription != null)
                                                            <span class="green_badge text-nowrap">-{{isset($subscriptionDiscountPercentage) ? $subscriptionDiscountPercentage:0 }}%</span>
                                                                <h4 class="font_10 set_font_weight m-0">-{{single_price(isset($individual_product_total_subscription_discount) ? $individual_product_total_subscription_discount:0)}}</h4>
                                                                @else
                                                                @php
                                                                ...
                                                                @endphp 
                                                               <span class="green_badge text-nowrap">-{{isset($defaultDiscountPercentage) ? $defaultDiscountPercentage:0 }}%</span>
                                                        ...
                                                        <div class="col-lg-2 text-center">
                                                            ...
                                                            <h4 class="font_10 set_font_weight m-0 lh-1 text-nowrap">
                                                    ...
                                                    <div class="row gutters-5 align-items-center">
                                                        <div class="col-lg-4 d-flex">
                                                            <a href="{{route('frontend.gift-card.show',$cart->giftCard->sku)}}" class="d-flex align-items-center gap_20 cart_thumb_div">
                                                                ...
                                                                <div class="summery_pro_content">
                                                                    <h4 class="font_10 set_font_weight m-0 theme_hover">{{ textLimit(@$cart->giftCard->name, 35) }}</h4>
                                                                </div>
                                                            </a>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-2 text-center">
                                                            ...
                                                            @if(auth()->check() && $customerSubscription !== null)
                                                             <span class="green_badge text-nowrap">-{{isset($subscriptionDiscountPercentage) ? $subscriptionDiscountPercentage:0 }}%</span>
                                                                 <h4 class="font_10 set_font_weight m-0">-{{single_price(isset($total_subscription_discount) ? $total_subscription_discount:0)}}</h4>
                                                                 @else
                                                                 @php
                                                                 $subscriptionPlan = Modules\FrontendCMS\Entities\PricingPlan::where('name', 'TIER 3')->first();
                                                                 $discountRoles = [];
                                                                 ...
                                                                 @endphp 
                                                                <span class="green_badge text-nowrap">-ff{{isset($defaultDiscountPercentage) ? $defaultDiscountPercentage:0 }}%</span>
                                                                <h4 class="font_10 set_font_weight m-0 default-discount-value"></h4>     
                                                             @endif
                                                        </div>
                                                        <div class="col-lg-2 d-flex">
                        ...
                        <div class="d-flex gap_10 align-items-center flex-wrap mt_20">
                            ...
                            <a class="amaz_primary_btn min_200 style2 cursor_pointer @if (count($cartData) > 0) process_to_checkout_check @endif" data-sub-discount="{{@$total_subscription_discount}}" data-value="{{$selected_product_check}}" data-id="{{encrypt($seller_id)}}">{{__('defaultTheme.proceed_to_checkout')}}</a>
                        </div>
                    </div>
                <!-- for wholesale module -->
