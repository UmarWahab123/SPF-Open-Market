...
<form action="{{route('frontend.checkout')}}" method="GET" enctype="multipart/form-data" id="mainOrderForm">
    <input type="hidden" name="sub_discount" value="{{$sub_discount}}">
        ...
        <div class="checkout_v3_left d-flex justify-content-end">
            <div class="checkout_v3_inner" >
                ...
                @if(isModuleActive('MultiVendor'))
                    ...
                    @endphp
                    <div class="checout_head_title d-flex align-items-center d-none">
                    ...
                    @foreach($cartData as $seller_id => $packages)
                        ...
                        @if(isModuleActive('INTShipping'))
                            ...
                            @endphp
                        @endif
                        <div class="checkout_shiped_box mb_20 d-none">
                            @if(!isModuleActive('INTShipping'))
                    ...
                    <div class="billing_address">
                        ...
                        <div class="row shipping_address_edit_div {{$shipping_address?'d-none':""}}">
                            ...
                            <div class="col-lg-6 mb_20">
                                ...
                                <input class="primary_input3 style5 radius_3px" type="text"  id="postal_code" name="postal_code" placeholder="{{__('common.postal_code')}}" value="{{$shipping_address?$shipping_address->postal_code:''}}" required>
