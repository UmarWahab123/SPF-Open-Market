                    ...
                    <form action="{{ route('frontend.profile.quiz.store') }}" method="POST"  id="register_form" enctype="multipart/form-data">
                            ...
                            <div class="step" id="step-1">   
                                   ...
                                   <div class="col-md-6 mb_20">
                                        ...
                                        <input name="first_name" id="first_name" value="{{ old('first_name') }}"  onfocus="this.placeholder = ''"  class="primary_input3 radius_5px" type="text">
                                    ...
                                    <div class="col-md-6 mb_20">
                                        ...
                                        <input name="last_name" id="last_name" value="{{ old('last_name') }}"  onfocus="this.placeholder = ''"  class="primary_input3 radius_5px" type="text">
                         ...
                         <div class="row">
                                      <div class="form-group col-md-6 mb_20">
                                        ...
                                        <input type="text" value="{{ old('Billing_address') }}" class="form-control primary_input3 radius_5px" id="Billing_address" name="Billing_address" required onchange="fetchAddressData1()">
                                    ...
                                    <div class="form-group col-md-6 mb_20">
                                        ...
                                        <input type="text" value="{{ old('Shipping_address') }}" class="form-control primary_input3 radius_5px" id="Shipping_address" name="Shipping_address"  required  onchange="fetchAddressData()">
                                   ...
                                   <div  class="form-group col-md-6 mb_20">
                                     ...
                                     <div  class="form-group col-md-6 mb_20">
                                       ...
                                       <div  class="form-group col-md-6 mb_20" style='display:none;'>
                                            ...
                                            <select value="{{ old('hours') }}" class="form-control primary_input3 radius_5px" id="hours" name="hours" >
                                                <option value="yes">Yes</option>
                                                <option value="no">No</option>
                                            </select>
                                        </div>
                         ...
                         <div class="step" id="step-3" style="display: none;">
                          <div class="row">
                                        ...
                                        <div class="form-group col-md-6 mb_20">
                                            ...
                                            <textarea id="special_instructions" class="form-control primary_input3 radius_5px" name="special_instructions" style="resize: none; height: 60px;">{{ old('special_instructions') }}</textarea>
                                        ...
                                        <div  class="form-group col-md-6 mb_20">
                                          ...
                                          <div  class="form-group col-md-6 mb_20">
                                            ...
                                            <input  value="{{ old('accounts_payable_email') }}" type="email"  class="form-control primary_input3 radius_5px" id="accounts_payable_email" name="accounts_payable_email" required>
