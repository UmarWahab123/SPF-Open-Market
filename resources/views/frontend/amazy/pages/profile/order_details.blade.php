                ...
                <div class="col-xl-8 col-lg-8">
                    ...
                    <div class="white_box style2 bg-white mb_30">
                        <div class="white_box_header gray_color_1 d-flex align-items-center gap_20 flex-wrap  theme_border justify-content-between ">
                            ...
                            <div class="d-flex flex-column  ">
                                <div class="d-flex align-items-center flex-wrap gap_5">
                                    <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.order_amount')}}: </h4> <p class="font_14 f_w_400 m-0 lh-base">{{ single_price($order->grand_total + $order->shipping_total) }}</p>
                                </div>
                            </div>
                            <div class="d-flex flex-column  ">
                        ...
                        <div class="dashboard_white_box_body dashboard_orderDetails_body">
                            @foreach ($order->packages as $key => $package)
                                <div class="order_prise d-flex justify-content-between gap-2 flex-wrap amazy_bb2 pb_11 mb_10">
                                    ...
                                    <h4 class="font_16 f_w_700 m-0">{{__('common.price')}}: {{ single_price($package->products->sum('total_price') + $package->gst_taxes->sum('amount') + $order->shipping_total)}}</h4>
                                    @else
                                    <h4 class="font_16 f_w_700 m-0">{{__('common.price')}}: {{ single_price($package->products->sum('total_price') + $package->tax_amount + $package->gst_taxes->sum('amount') + $order->shipping_total)}}</h4>
                                    @endif
                                ...
                                @if($package->is_cancelled == 0)
                                    ...
                                    <div class="d-flex align-items-center gap_20 flex-wrap gray_color_1 dashboard_orderDetails_head  justify-content-between theme_border">
                                        ...
                                        <div class="d-flex flex-column  ">
                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.order_amount')}}: </h4> <p class="font_14 f_w_400 m-0 lh-base"> {{ single_price($package->products->sum('total_price') + $order->shipping_total) }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($package->products as $key => $package_product)
                                                ...
                                                @else
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="{{singleProductURL(@$package_product->seller_product_sku->product->seller->slug, @$package_product->seller_product_sku->product->id)}}" class="d-flex align-items-center gap_20 cart_thumb_div">
                                                                <div class="thumb">
                                ...
                                <div class="summery_order_body d-flex flex-wrap">
                                    ...
                                    <div class="summery_lists flex-fill">
                                        ...
                                        <div class="single_summery_list d-flex align-items-start gap_20">
                                            ...
                                            <p class="font_14 f_w_400 m-0">{{single_price($order->grand_total + $order->shipping_total)}}</p>
                                        </div>
                                        <div class="single_summery_list d-flex align-items-start gap_20">
