                    ...
                    <div class="white_box style2 bg-white mb_20">
                        ...
                        <div class="dashboard_white_box_body">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <div class="flex-fill">
                                                @foreach ($package->products as $key => $package_product)
                                                    ...
                                                    @else
                                                        <a href="{{singleProductURL(@$package_product->seller_product_sku->product->seller->slug, @$package_product->seller_product_sku->product->id)}}" class="d-flex align-items-center gap_20 w-100 flex-fill @if(!$loop->last) amazy_bb3 @endif cart_thumb_div">
                                                            <div class="thumb">
                            ...
                            <div class="d-flex justify-content-between align-items-center g-2 mb_20 border gray_color_1 p-3">
                                ...
                                <span  class="f_w_500 font_20 m-0 text-capitalize secondary_text ">{{ single_price($order->grand_total + $order->shipping_total) }}</span>
                            </div>
