                ...
                <div class="amazy_login_form">
                        ...
                        <div style="color: white; font-family: Arial, sans-serif; border-radius: 8px;">
                            ...
                            <div class="top_three_input_fields">
                                <div style="flex: 1;">
                                    ...
                                    <input type="text" id="first_name" name="seller[first_name]" placeholder="First name" class="form-input">
                                    <span class="text-danger" id="first_name_error"></span>
                                </div>
                                <div style="flex: 1;">
                                    <label class="form-label">Middle Name(s)</label>
                                    <input type="text" id="middle_name" name="seller[middle_name]" placeholder="Middle Name(s)" class="form-input">
                                    <span class="text-danger" id="middle_name_error"></span>
                                </div>
                                <div style="flex: 1;">
                                    <label class="form-label">Last Name</label>
                                    <input type="text" id="last_name"  name="seller[last_name]" placeholder="Last Name" class="form-input">
                            ...
                            <div class="top_three_input_fields">
                                ...
                                <div style="flex: 1;">
                                    ...
                                    <div style="display: flex; gap: 5px;">
                                        <select name="seller[date_of_birth_day]" id="date_of_birth_day" style="flex: 1; padding: 8px; border: 2px solid white; background: transparent; color: white; border-radius: 5px;">
                                        ...
                                        <select name="seller[date_of_birth_month]" id="date_of_birth_month" style="flex: 1; padding: 8px; border: 2px solid white; background: transparent; color: white; border-radius: 5px;">
                                        ...
                                        <select name="seller[date_of_birth_year]" id="date_of_birth_year" style="flex: 1; padding: 8px; border: 2px solid white; background: transparent; color: white; border-radius: 5px;">
                    ...
                    <div class="step" style="margin-top:15px; align-items: center; border: 3px solid white; padding: 20px; border-radius: 20px; margin-bottom: 20px;">
                        <div>
                            ...
                            <input type="checkbox" value="beneficial_owner_check" name="seller[beneficial_owner_check]">
                            <span class="checkmark"></span>
                            </label>
                            <label class="checkbox_design">  Is A Legal Representative Of The Business
                             <input type="checkbox" value="legal_representative_check" name="seller[legal_representative_check]">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                    ...
                    <div class="step" style="margin-top:15px; align-items: center; border: 3px solid white; padding: 20px; border-radius: 20px; margin-bottom: 20px;">
                       <div>
                            ...
                            <input type="checkbox" value="privately_owned" name="business_type">
                            <span class="checkmark"></span>
                        </div>
                    ...
                    <div style="text-align: center; margin-top: 15px; display: flex; justify-content: center; gap: 10px;">
                        <button type="button" id="saveButton" onclick="checkFillstep1()" style="height: 33px; margin-left: 100px; width: 120px; font-weight: 700; background: white; border: none; border-radius: 5px;">Next</button>
                    </div>
...
<div class="amazy_login_area" style="display:none;" id="step-2">
    <div class="amazy_login_area_left_seller d-flex align-items-center justify-content-center" style="background: linear-gradient(90deg, rgba(6, 30, 33, 1) 0%, rgba(34, 56, 29, 1) 100%);">
        <div class="divider">
            <div class="amazy_login_form">
                <!-- Logo -->
            ...
            <div class="amazy_login_form">
                    ...
                    <!-- Buttons -->
                    <div style="text-align: center; margin-top: 15px; display: flex; justify-content: center; gap: 10px;">
                        <button type="button"  onclick="prevStep()" style="height: 33px; width: 120px; font-weight: 700; background: #00b234; border: none; border-radius: 5px;">Previous</button>
...
function checkFillstep1() {
    ...
    if (!businessTypeCheckbox) {
        ...
        if (errorElement) {
            errorElement.textContent = 'Please confirm that you are acting on your own behalf or behalf of a registered business.';
        }
        isValid = false;
    }
