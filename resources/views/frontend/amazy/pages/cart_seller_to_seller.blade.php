            ...
            $(document).ready(function(){
                ...
                $(document).on('click', '.process_to_checkout_check', function(event){
                    ...
                    if(count<=0){
                        ...
                        var base_url = $('#url').val();
                        var subDiscount = $(this).data('sub-discount')
                        window.location.href = base_url + "/checkout?owner=" + seller_id + "&sub_discount=" + subDiscount;
                    }
                });
...
//    $(document).ready(function () {
//     // Get the text of the #default-discount span
//       var discountValue = $('#default-discount').text();

//     // Write the text into the #default-discount-value span
//         $('.default-discount-value').text(discountValue);
//     });
