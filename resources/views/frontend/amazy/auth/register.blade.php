        ...
        <div class="amazy_login_area_left d-flex align-items-center justify-content-center" style="background: linear-gradient(90deg, rgba(6, 30, 33, 1) 0%, rgba(34, 56, 29, 1) 100%);">   
            <div class="amazy_login_form" style="max-width: 500px;">
                ...
                <div class="top_logo_div_seller">
                    <h3 class="m-0 mb-3" style="color: #01c701;">Buyer Sign Up</h3><img style="height: 39px; width: auto; margin-right: -30px;margin-bottom:20px;" src="{{asset('public/frontend/amazy/img/home/logo-spf-09.png')}}">
                </div>
                <p class="support_text d-none">{{__('auth.See your growth and get consulting support!')}}</p>
                <form id="registerForm" action="{{ route('register') }}" method="POST" class="register_form">
                    @csrf
                    <div class="row" style="border: 3px solid white; padding: 20px; border-radius: 20px;">
                        ...
                        @else
                            ...
                            <div class="col-lg-12 mb_20" style="display:none;">
                             ...
                             <div class="col-lg-12 mb_20">
                                <label style="color:white; font-size:20px; font-weight: 600; "  class="primary_label2">Your Name:</label>
                                <input style="background: transparent; border: 2px solid white; color: white; font-size: 20px; height: 35px;" type="text" name="first_name" id="Shop" value="{{old('first_name')}}" placeholder="First and last name" class="primary_input3 radius_5px">
                                @error('first_name')
                                    <span class="text-danger" >{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-12 mb_20">
                                ...
                                <input style="background: transparent; border: 2px solid white; color: white; font-size: 20px; height: 35px;" type="text" id="Phone_number" name="Phone_number" value="{{old('Phone_number')}}" placeholder="{{ __('common.phone_number') }}" onfocus="this.placeholder = ''" onblur="this.placeholder = '{{ __('common.phone_number') }}'" class="primary_input3 radius_5px">
                                @error('Phone_number')
                                    <span class="text-danger" >{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        @endif
                            ...
                            <div class="col-12 mb_20">
                            <p style="color:white;">By Creating An Account, You Agree To SPF <a href="#" style="color:#00b234;">Conditions Of Use</a> And <a href="#" style="color:#00b234;"> Privacy Notice</a></p>
                                {{-- <label class="primary_checkbox d-flex">
                                    <input checked="" type="checkbox" id="termCheck" checked value="1">
                                    <span class="checkmark mr_15"></span>
                                    <span class="label_name f_w_400 ">{{ __('defaultTheme.by_signing_up_you_agree_to_terms_of_service_and_privacy_policy') }}</span>
