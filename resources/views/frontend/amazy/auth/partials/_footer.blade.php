...
<div class="eleven_section">
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center"> <a href="#" class="top_of_page" onclick="topFunction()" id="myBtn">Top of page</a> </div>
    </div>
    <div class="row">
      <div class="col-md-3">
      ...
      <div class="col-md-6">
        <div class="footer_section"> <img src="{{asset('public/frontend/amazy/img/home/logo.png')}}"><br>
      ...
      <div class="col-md-3">
       <div class="footer_section_left">
          <ul>
            <li>Contact us at</li>
            <li>+88 888 123 123</li>
            <li>info@spfopenmarket.com</li>
            <li>Calle avenida 30</li>
          </ul>
        </div>
      </div>
    </div>
